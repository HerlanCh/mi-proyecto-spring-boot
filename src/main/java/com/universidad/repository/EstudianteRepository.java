...
public class EstudianteRepository {
    ...
    public Estudiante findById(Long id) { // Metodo para obtener un estudiante por su ID
        return estudiantes.get(id); // Retorna el estudiante si existe, o null si no está en el mapa
    }

    public boolean existePorId(Long id) {
        return estudiantes.containsKey(id); // Retorna true si el estudiante existe en el mapa
    }
